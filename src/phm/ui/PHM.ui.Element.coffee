...
(->
  ...
  exports.PHM.ui.Element =
    ...
    toggleChildElementClass: (selector, name) ->
      element = @getChildElement(selector)
    ...
    focusChildElement: (selector)->
      @getChildElement(selector).focus()
    ...
    emptyChildElement: (selector) ->
      element = @getChildElement(selector)
      element.empty()
    isChildElementVisible: (selector) ->
      element = @getChildElement(selector)
      !element.hasClass('state-hidden')
)()
